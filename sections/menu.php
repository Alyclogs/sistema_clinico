...
$activeUsuarios = ($base_url . 'views/Clinica/usuarios/index.php') === 0 ? 'active' : '';
$activeCalendario = ($base_url . 'views/Clinica/agenda/calendario.php') === 0 ? 'active' : '';
$activeEspecialista = ($base_url . 'views/Clinica/especialistas/index.php') === 0 ? 'active' : '';
