        ...
        <div class="card page-card">
            <div class="card-header page-card-header rounded-4">
                <div class="d-flex justify-content-between align-items-center my-3">
                    <h2 class="mb-0 text-secondary"><i class="bi bi-people-fill me-2"></i>Gestión de Usuarios</h2>
                    <button class="btn btn-primary btn-add-user" data-bs-toggle="modal" data-bs-target="#usuarioModal">
                        <i class="bi bi-plus-circle-fill me-1"></i> Agregar Usuario
                    </button>
                </div>
                <div class="card-body">
