                      ...
                      <div class="form-container-two">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-group">
                            ...
                            <div class="campo-flex-end">
                              <input class="form-control" type="number" id="monto" name="monto" min="0" readonly>
                            </div>
                          </div>
...
<script>
  ...
  document.getElementById('modalidad-pago').addEventListener('change', function() {
    ...
    opcionPagoSelect.innerHTML = '<option value="">Seleccione</option>';
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const pagarInput = document.getElementById('importexpagar');
    const deudaInput = document.getElementById('deudaxpagar');

    pagarInput.addEventListener('input', function() {
      const total = parseFloat(montoInput.value) || 0;
      const pagado = parseFloat(pagarInput.value) || 0;
