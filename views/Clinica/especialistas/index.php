...
$especialisataModel = new EspecialistaModel();
...
<body>
                            ...
                            <div class="content-body">
                                <div class="table-responsive">
                                    <table class="table align-middle">
                                        ...
                                        <tbody id="tablaEspecialistasBody"></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <div class="svg-x-end">
                    <div class="cabecera-form">
                        ...
                        <p>Complete los campos ingresando los datos de los especialistas:</p>
                    </div>
                ...
                <div class="modal-footer justify-content-left">
                    <div id="botonesModal">
                        ...
                        <button type="button" class="btn btn-primary btn-guardar" id="btnGuardarUsuario">Guardar Registro</button>
                    </div>
    ...
    <div class="modal fade" id="horarioModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="svg-x-end">
                    <div class="cabecera-form">
                        <span class="title-span">Disponibilidad </span>
                        <p>Complete los campos según la disponibilidad de los pacientes:</p>
                    </div>
                    <!-- Eliminar data-bs-dismiss="modal" y usar el evento click -->
                    <div class="svg-x" id="closeHorarioModal">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.15 12.89">
                            <defs>
                                <style>
                                    .cls-equis {
                                        fill: none;
                ...
                <div class="modal-body" id="horarioModalBody">
                </div>
                <div class="modal-footer justify-content-left">
                    <div id="botonesModalHorario">
                        <button type="button" class="btn btn-secondary btn-cancelar" id="btnCancelarHorario">Cancelar</button>
                        <button type="button" class="btn btn-primary btn-guardar" id="btnGuardarHorario">Guardar Cambios</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="servicioModal" tabindex="-1"
        aria-labelledby="servicioModalLabel" aria-hidden="true"
        data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="svg-x-end">
                    <div class="cabecera-form">
                        <span class="title-span">Servicios </span>
                        <p>Seleccione los servicios , áreas y especialidades a realizar de los especialistas:</p>
                    </div>
                    <div class="svg-x" data-bs-dismiss="modal">
                ...
                <div class="modal-body" id="servicioModalBody">
                </div>
                <div class="modal-footer justify-content-left">
                    <div id="botonesModalServicio">
                        <button type="button" class="btn btn-secondary btn-cancelar" data-bs-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-primary btn-guardar" id="btnGuardarServicios">Guardar Cambios</button>
                    </div>
...
<script src="<?php echo $base_url ?>assets/js/especialistas/tablaEspecialistas.js"></script>
