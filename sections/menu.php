...
$menuLinks = [
  'superusuario' => [
    'usuarios' => 'views/Clinica/usuarios/index.php',
    'calendario' => 'views/Clinica/agenda/calendario.php',
    'especialistas' => 'views/Clinica/especialistas/index.php',
    'pagos' => 'views/Clinica/pagos/index.php'
  ],
  'especialista' => [
    'calendario' => 'views/Doctor/agenda/calendario.php'
  ]
];

// Controlar la clase 'active' para un enlace específico
$rol = strtolower($rol_usuario);
$activeUsuarios = (isset($menuLinks[$rol]['usuarios']) && strpos($current_url, $base_url . $menuLinks[$rol]['usuarios']) === 0) ? 'active' : '';
$activeCalendario = (isset($menuLinks[$rol]['calendario']) && strpos($current_url, $base_url . $menuLinks[$rol]['calendario']) === 0) ? 'active' : '';
$activeEspecialista = (isset($menuLinks[$rol]['especialistas']) && strpos($current_url, $base_url . $menuLinks[$rol]['especialistas']) === 0) ? 'active' : '';
$activePagos = (isset($menuLinks[$rol]['pagos']) && strpos($current_url, $base_url . $menuLinks[$rol]['pagos']) === 0) ? 'active' : '';
  ...
  <div class="menu-izquierdo">
    <div class="arriba-flex">
      ...
      <div class="menu-iconos">
        ...
        <?php if (isset($menuLinks[strtolower($rol_usuario)]['usuarios'])) {
        ?>
          <div class="caja-menu <?php echo $activeUsuarios; ?>" style="display: <?= $displayUsuarios ?>;" onclick="window.location.href='<?= $base_url . $menuLinks[strtolower($rol_usuario)]['usuarios'] ?>'">
            <div class="svg-menu">
        ...
        <?php if (isset($menuLinks[strtolower($rol_usuario)]['especialistas'])) {
        ?>
          <div class="caja-menu <?php echo $activeEspecialista; ?>" onclick="window.location.href='<?= $base_url . $menuLinks[strtolower($rol_usuario)]['especialistas'] ?>'">
            <div class="svg-menu">
        ...
        <?php if (isset($menuLinks[strtolower($rol_usuario)]['calendario'])) {
        ?>
          <div class="caja-menu <?php echo $activeCalendario; ?>" onclick="window.location.href='<?= $base_url . $menuLinks[strtolower($rol_usuario)]['calendario'] ?>'">
            <div class="svg-menu">
        ...
        <?php if (isset($menuLinks[strtolower($rol_usuario)]['pagos'])) {
        ?>
          <div class="caja-menu <?php echo $activePagos; ?>" onclick=" window.location.href='<?= $base_url . $menuLinks[strtolower($rol_usuario)]['pagos'] ?>'">
            <div class=" svg-menu">
